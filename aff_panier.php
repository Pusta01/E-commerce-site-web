...
<a class="navbar-brand" href="index.php">LaVidaShop</a>
    ...
    <li class="nav-item">
        <a class="nav-link active" style="font-weight: bold;" aria-current="page" href="../admin/afficher.php">Mon_panier</a>
        </li>
...
<?php foreach($produits as $produit): ?>
                <tr>
                <th scope="row"><?= $produit->user_id ?></th>
                <td>
