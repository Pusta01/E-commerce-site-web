...
<div class="container">
    ...
    <div class="col-sm-4 offset-md-1 py-4">
        ...
        <li><a href="aff_panier.php" class="text-white">Mon Panier</a></li>
        </ul>
    </div>
    </div>
</div>
        ...
        <div class="col-md-8">
            <div class="card shadow-sm" >
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                    <a href="panier.php?pdt=<?= $produit->id ?>"><button type="button" class="btn btn-sm btn-success">Commander</button></a>
                    </div>
