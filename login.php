    ...
    <div class="row">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <input placeholder=" se connecter avec admin@admin.com" type="email" name="email" class="form-control" style="width: 350%;" >
            </div>
            <div class="mb-3">
                <label for="motdepasse" class="form-label">Mot de passe</label>
                <input placeholder="Mot de passe pour admin est 123456" type="password" name="motdepasse" class="form-control" style="width: 350%;">
            </div>
            <br>
